      ...
      <div className="container row choosecontainer m-auto">
        <div className="col-md-3 choosecard my-5" data-aos="flip-up">
          <div className="choose-icon">
            ...
            <h4>Diverse Fleet​</h4>
            <p>
            Choose from a variety of limousines including classic stretch
              limos, executive sedans, spacious SUVs,Lorem ipsum dolor sit amet
              consectetur, adipisicing elit. Porro, corrupti.
            </p>
          </div>
        </div>
