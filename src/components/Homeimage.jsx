...
function Homeimage() {
  ...
  useEffect(() => {
    ...
    fetch("https://demo.nerdtech.in/limousine/backend/add_newposter.php")  // Replace with your correct API endpoint
    ...
    <div className="image-container">
      <div className="overlay">
        <div className="contents">
          ...
          <Link to="/booknow" className="btn  mt-3 bookbtn">
              Book Now
            </Link>
        </div>
      </div>
      <img
  src={`https://demo.nerdtech.in/limousine/${imageData.poster_img}`}
